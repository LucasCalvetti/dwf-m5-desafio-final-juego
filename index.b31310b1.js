...
},{"url:../../img/papel.png":"fTpqS","url:../../img/tijera.png":"9JARl","url:../../img/piedra.png":"j1GzX"}],"fTpqS":[function(require,module,exports) {
...
},{}],"9JARl":[function(require,module,exports) {
...
customElements.define("result-img", class ResultImg extends HTMLElement {
    ...
    render() {
        ...
        var imageURL = "";
        if (this.result == "win") imageURL = winImg;
        else imageURL = loseImg;
...
},{"url:../../img/star-lose.png":"hzBJB","url:../../img/star-win.png":"iblvL"}],"hzBJB":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('Z8Pbo') + "star-lose.c772cb6e.png";

},{"./helpers/bundle-url":"8YnfL"}],"iblvL":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('Z8Pbo') + "star-win.8c600855.png";
...
function initGame(params) {
    ...
    for (let p of playerPlaysArray){
        ...
        p.addEventListener("click", (e)=>{
            ...
            if (thisPlayEl.classList.contains("selected")) thisPlayEl.classList.remove("selected");
                ...
                for (let i of playerPlaysArray)if (i.classList.contains("selected")) {
    ...
    */ const countDownInterval = setInterval(()=>{
        ...
        if (intervalCounter == 0 && playerPlayEl == "none") timesUp();
...
(function() {
    ...
    if (localState) state.setState(JSON.parse(localState));
})();
...
},{"../../../state":"28XHA","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}]},["8uBhv","4aleK"], "4aleK", "parcelRequire09ba")
